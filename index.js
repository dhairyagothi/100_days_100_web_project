  ...
  return {
    html: `
            ...
            <div class="card-preview-image-container" style="margin: 12px 0; border-radius: 8px; overflow: hidden; aspect-ratio: 16/9; background: #1a1a1a;">
               <img src="${url && url.startsWith('./') ? url.substring(0, url.lastIndexOf('/')) : ''}/preview.png"alt="${safeName} preview" onerror="this.onerror=null; this.src='./public/placeholder.png';" style="width: 100%; height: 100%; object-fit: cover;">
            </div>
