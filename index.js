...
const PROJECT_DESCRIPTIONS = {
  ...
  "Neon Forge":
    "Interactive CSS neon glow effects playground for creating custom neon text with live preview, color customization, and PNG export. Creative frontend design tool."
