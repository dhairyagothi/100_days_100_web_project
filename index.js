...
function buildProjectCardHTML({
  ...
  const codeLink = sourceOnly
    ? ""
    : `<a href="${safeSourceUrl}" target="_blank" class="card-link view-source-link" rel="noopener noreferrer" onclick="event.stopPropagation()" aria-label="View source code of ${safeName} on GitHub (opens in a new tab)" title="View source on GitHub">
                        <i class="fab fa-github" aria-hidden="true"></i>
                    </a>`;
