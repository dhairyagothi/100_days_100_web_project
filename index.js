...
function filterProjects() {
    ...
    rows.forEach(table => {
        console.log(table)
        const projectName = table.querySelector('.').innerText.toLowerCase();
