...
const PROJECT_DATA = [
  ...
  ['Day 136', 'Typing Race Game', './public/TypingRaceGame/index.html', 'html css javascript', 'intermediate'],
];
  ['Day 137', 'Shooting game', './public/shooting game/index.html', '2d game', 'intermediate'],
  ['Day 138', 'Sudoku Solver', './public/sudoku-solver/index.html', 'game javascript', 'intermediate'],
  ['Day 139', 'Maths Quiz Game', './public/maths-quiz-game/index.html', 'game javascript', 'intermediate'],
  ['Day 140', 'Age Calculator', './public/age-calculator/index.html', 'tool javascript', 'beginner'],
  ['Day 141', 'Ludo game', './public/Ludo-game/index.html', 'Html css javascript', 'intermediate'],
  ['Day 142', 'Big Sales Prediction', './public/BigSales-Prediction/frontend/index.html', 'machine learning python javascript', 'advanced'],
  ['Day 143', 'Dice Roller', './public/Dice-Roller/main.html', 'html css javascript', 'intermediate'],
  ['Day 144', 'Geo Guesser game', './public/geo-guesser/index.html', 'map game', 'intermediate'],
  ['Day 145', 'Morse Code Translator', './public/MorseCodeTranslator/index.html', 'html css javascript', 'beginner'],
  ['Day 146', 'Car Racing game', './public/racing game/index.html', 'html css js', 'intermediate'],
  ['Day 147', 'Magic 8 Ball', './public/magic-8ball/main.html', 'simulation html css javascript', 'beginner'],
  ['Day 148', 'Data Sructures Visualizer', './public/Data Structures Visualizer/index.html', 'visualizer', 'intermediate'],
  ['Day 149', 'Chronosphere', './public/Chronosphere/index.html', 'game canvas', 'intermediate'],
  ['Day 150', 'Contest Tracker', './public/ContestTracker/index.html', 'tool javascript', 'advanced'],


  ['Day 151', 'GitHub Profile Battle', './public/GitHub-Profile-Battle/index.html', 'tool javascript', 'advanced'],
  ['Day 152', 'App Privacy Policy Generator', './public/AppPrivacyPolicyGenerator/index.html', 'tool javascript', 'intermediate'],
  

  ['Day 153', 'Mini Carrom Game', './public/mini carrom/index.html', 'html css javascript', 'intermediate'],
  
  
  ['Day 154', 'Physics Ball Simulation', './public/PhysicsBallSimulation/index.html', 'html css javascript canvas', 'advanced'],
  ['Day 155', 'Material3 Showcase', './public/Material3Showcase/index.html', 'tool javascript', 'intermediate'],
  ['Day 156', 'FocusRoom', './public/FocusRoom/index.html', 'html css javascript productivity timer tasks ambient', 'intermediate'],
];
