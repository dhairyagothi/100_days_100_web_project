  ...
  return {
    html: `
            ...
            <div class="card-preview-image-container" style="margin: 12px 0; border-radius: 8px; overflow: hidden; aspect-ratio: 16/9; background: #1a1a1a;">
                <img src="${(url && url.startsWith('./')) ? url.split('/').slice(0, -1).join('/') + '/preview.png' : './' + name.replace(/\s+/g, '_') + '/preview.png'}" alt="${safeName} preview" onerror="this.parentNode.style.display='none';" style="width: 100%; height: 100%; object-fit: cover;">
            </div>
