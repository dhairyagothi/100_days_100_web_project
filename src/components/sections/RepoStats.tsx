  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 w-full">
      {statItems.map((item) => (
        <div 
          key={item.label}
          className="bg-card/50 backdrop-blur-sm border border-border/50 p-3 md:p-4 rounded-2xl flex flex-col items-center justify-center space-y-1.5 md:space-y-2 hover:border-primary/20 transition-colors"
        >
