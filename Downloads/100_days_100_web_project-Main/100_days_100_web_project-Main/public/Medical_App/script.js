document.addEventListener('DOMContentLoaded', () => {
  ...
  const MEDICINE_CATALOG = Object.freeze({
    ...
    headache: {
      ...
      guidelines:
        'Maintain aggressive liquid hydration and avoid excessive screen emission exposure.',
      contraindications: 'Active stomach ulcers',
    },
    fever: {
      medicines: ['Paracetamol (Acetaminophen)'],
      guidelines:
        'Track thermal core temperature variations carefully. Avoid exceeding 4,000mg per 24 hours.',
      contraindications: 'Advanced liver impairment',
    },
    fatigue: {
      medicines: ['Multivitamin Supplements', 'Electrolyte Replacements'],
      guidelines:
        'Ensure consistent REM sleep cycles, hydration balance, and balanced caloric nutrition intake.',
