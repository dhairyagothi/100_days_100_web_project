        ...
        <Card className="shadow-2xl overflow-hidden border-0">
          <div className="bg-gradient-to-br from-primary via-primary/90 to-accent/70 p-8 text-center relative">
            ...
            <div className="relative z-10">
              ...
              <p className="opacity-90 mt-2 font-medium text-primary-foreground">
                Successfully registered for Zenith 2026
              </p>
            </div>
          </div>
          ...
          <div className="p-8 bg-card relative">
            <div className="absolute -top-4 left-8 right-8 h-8 flex justify-between">
              {Array.from({ length: 10 }).map((_, i) => (
                <div
                  key={i}
                  className="w-3 h-3 rounded-full bg-background shadow-inner border border-border -mt-1.5"
                ></div>
              ))}
            </div>
              ...
              <div className="text-center">
                ...
                <div className="inline-flex items-center gap-2 bg-muted px-4 py-2 rounded-lg border border-border/50">
                  ...
                  <span
                    ...
                    data-testid="text-registration-id"
                  >
                    {data.registrationId}
                  </span>
                </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="inline-flex mt-0.5">
                      <span
                        className={`px-2 py-0.5 text-xs font-semibold rounded-md ${data.domain === 'Tech' ? 'bg-primary/15 text-primary' : 'bg-accent/15 text-accent'}`}
                      >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium text-foreground text-sm truncate" title={data.email}>
                      {data.email}
                    </p>
                  </div>
                  <div>
