...
async function fetchWikipediaSummary(wikiTitle, signal) {
  const response = await fetch(`${WIKIPEDIA_SUMMARY_BASE}/${encodeURIComponent(wikiTitle)}`, {
    signal,
  });
...
async function applyNasaDecorativeBackgrounds() {
  try {
    ...
    const imageLink =
      item?.links?.find((link) => link.render === 'image' || link.rel === 'preview')?.href ||
      item?.href;
...
function bindEvents() {
  ...
  newsScroll.addEventListener('scroll', () => {
    const nearBottom =
      newsScroll.scrollTop + newsScroll.clientHeight >= newsScroll.scrollHeight - 40;
...
const QUIZ_QUESTIONS = {
  easy: [
    ...
    },
    {
      ...
      correct: 1,
      explain: 'Sunlight travels ~150 million km to reach Earth in about 8 minutes and 20 seconds.',
    },
    {
    ...
    },
    {
      ...
      correct: 2,
      explain: 'Mars gets its reddish color from iron oxide (rust) on its surface.',
    },
    {
      q: 'How many planets are in our Solar System?',
      options: ['7', '8', '9', '10'],
      correct: 1,
      explain: 'There are 8 planets. Pluto was reclassified as a dwarf planet in 2006.',
    },
    {
    ...
    },
    {
      ...
      correct: 2,
      explain: 'Gravity is the attractive force between masses that governs orbital motion.',
    },
  ],
  medium: [
    {
      ...
      correct: 2,
      explain: 'Ganymede is the largest moon in the Solar System, even bigger than Mercury.',
    },
    {
    ...
    {
      q: 'What is a parsec?',
      options: ['~3.26 light-years', '~1 light-year', '~10 light-years', '~100 AU'],
      correct: 0,
      explain: 'One parsec ≈ 3.26 light-years, defined by a parallax angle of one arcsecond.',
    },
    {
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['4.6 billion years', '8.8 billion years', '13.8 billion years', '20 billion years'],
      correct: 2,
    ...
    },
    {
      ...
      options: ['Mass', 'Rotation of a massive body', 'Electric charge', 'Magnetic fields'],
      correct: 1,
      explain:
