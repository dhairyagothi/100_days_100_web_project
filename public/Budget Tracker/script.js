...
modeToggle.addEventListener('change', () => {
  ...
  showToast(
    document.body.classList.contains('dark') ? 'Dark Mode Enabled 🌙' : 'Light Mode Enabled ☀️'
  );
});
...
function updateBudget() {
  ...
  if (monthlyBudget <= 0) {
    ...
    smartSuggestionEl.textContent = 'Set a monthly budget to track spending 📊';

    financialStatusEl.textContent = 'Budget not configured';
