!(function () {
  ...
  var v,
    ...
    z = function e() {
      let t = H(f);
      return (
        t || (sessionStorage.getItem(f) ? sessionStorage.getItem(f) : "default")
      );
    },
    Q = function () {
      var e =
      ...
      if (i == ee.async) {
        if (navigator.sendBeacon)
          ("bulk" === t.eventType || (r && "tds_Bulk_Call" === r.eventType)
            ? eo(a, r) &&
              (navigator.sendBeacon(en, JSON.stringify(er)),
              (ei = 0),
              (er = []))
          ...
          ((c.src = et + "?data=" + a),
            ...
            C().dispatch(
              ((o = t.eventId),
              { type: u, payload: { eventId: o, status: (s = V.loading) } }),
            ));
        }
      }
    },
        ...
        $(e, [
          ...
          },
          {
            ...
            value: function e() {
              ...
              if (
                (this.getWhiteListedKeys(r, this.blackListed).forEach(
                  function (e) {
                    B(e) && (n[e] = B(e));
                  },
                ),
  ...
  let e_ = {
    PIXEL_URL: "https://partners.infoedge.com/tds",
        ...
        function f(e) {
          if (
            !(function e(t) {
              ...
              return (
                "function" == typeof o && o instanceof o && eI.call(o) == eP
              );
            })(e)
          )
            throw Error(
