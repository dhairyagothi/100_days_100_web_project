        ...
        <div style={{ display: 'grid', gap: 16 }}>
          {jobs.map((j) => (
            <div
              ...
              style={{
                background: '#161b22',
                border: `1px solid ${selJob === j._id ? '#1f6feb' : '#30363d'}`,
                borderRadius: 12,
                padding: '18px 22px',
              }}
            >
              ...
              >
                <div>
                  ...
                  <p style={{ color: '#8b949e', fontSize: '0.88rem', marginTop: 4 }}>
                    {j.applicants?.length || 0} applicants · {j.location} · {j.type}
                  </p>
                </div>
                <button
                  onClick={() => loadApps(j._id)}
                  style={{
                    background: '#21262d',
                    color: '#c9d1d9',
                    border: '1px solid #30363d',
                      ...
                      >
                        ...
                        >
                          <div>
                            ...
                            {a.candidate?.bio && (
                              <p style={{ color: '#8b949e', fontSize: '0.83rem', marginTop: 4 }}>
                                {a.candidate.bio}
                              </p>
                            )}
                          </div>
                        ...
                        >
                          <strong style={{ color: '#c9d1d9' }}>Cover letter:</strong>{' '}
                          {a.coverLetter}
                        </p>
                      </div>
                    ))
          ...
          {apps.map((a) => (
            ...
            >
              ...
              >
                ...
                <span
                  className={`badge ${statusBadge[a.status]}`}
                  style={{ fontSize: '0.88rem', padding: '5px 14px' }}
                >
                  {a.status}
                </span>
              </div>
              <p style={{ color: '#8b949e', fontSize: '0.83rem', marginTop: 10 }}>
                Applied{' '}
