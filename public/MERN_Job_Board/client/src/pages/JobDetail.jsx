...
export default function JobDetail() {
  ...
  if (loading)
    return <p style={{ textAlign: 'center', marginTop: 80, color: '#8b949e' }}>Loading...</p>;
  if (!job)
    return <p style={{ textAlign: 'center', marginTop: 80, color: '#f85149' }}>Job not found.</p>;
      ...
      <div style={{ maxWidth: 780, margin: '0 auto' }}>
        ...
        >
          ...
          >
            <div>
              <h1
                style={{ color: '#c9d1d9', fontSize: '1.6rem', fontWeight: 700, marginBottom: 6 }}
              >
                {job.title}
              </h1>
        ...
        >
          <h2 style={{ color: '#c9d1d9', marginBottom: 14, fontSize: '1.1rem' }}>
            Job Description
          </h2>
          <p style={{ color: '#8b949e', lineHeight: 1.75, whiteSpace: 'pre-line' }}>
            {job.description}
          </p>
        </div>
        ...
        {user?.role === 'candidate' && (
          ...
          >
            <h2 style={{ color: '#c9d1d9', marginBottom: 16, fontSize: '1.1rem' }}>
              Apply for this role
            </h2>
            {applied ? (
              <div
