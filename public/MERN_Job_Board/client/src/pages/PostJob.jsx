  ...
  return (
    ...
    >
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        ...
        <p style={{ color: "#8b949e", marginBottom: 28, fontSize: "0.9rem" }}>
          Live on the board the moment you submit ⚡
        </p>
        <form
          onSubmit={submit}
          style={{
        ...
        >
          ...
          <div>
            <label style={lbl}>Salary (optional)</label>
            <input
              name="salary"
              placeholder="₹12–18 LPA / $80k–100k"
              value={form.salary}
              onChange={ch}
              style={inp}
            />
