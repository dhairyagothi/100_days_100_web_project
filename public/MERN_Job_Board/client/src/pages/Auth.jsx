  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ color: '#8b949e', textAlign: 'center', fontSize: '0.9rem', marginBottom: 28 }}>
          Real-time Jobs Platform
        </p>
            ...
            <>
              ...
              {form.role === 'candidate' && (
                <div>
                  ...
                  <input
                    name="bio"
                    placeholder="Full-stack dev, 2 yrs exp"
                    value={form.bio}
                    onChange={ch}
                    style={inp}
                  />
