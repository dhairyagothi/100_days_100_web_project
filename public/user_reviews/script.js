...
const SEED_REVIEWS = [
  {
    ...
    name: 'Aryan Kumar',
    rating: 5,
    text: 'This project taught me so much. The variety of web projects in 100 days is genuinely impressive — each one covers a different concept.',
    date: '2025-05-12',
  },
  {
    id: 2,
    name: 'Sneha Rao',
    rating: 4,
    text: 'Great for beginners. I especially liked the JavaScript mini-projects. Would love more comments in the code for learning purposes.',
    date: '2025-04-28',
  },
  {
    id: 3,
    name: 'Mihail T.',
    rating: 5,
    text: 'Forked this and used it as a personal practice repo. The structure is clean and easy to navigate. Highly recommend for anyone learning frontend.',
    date: '2025-03-15',
  },
  {
    id: 4,
    name: 'Priya L.',
    rating: 3,
    text: 'Good collection overall. Some projects could use responsive design improvements. But a solid reference for HTML/CSS patterns.',
    date: '2025-02-20',
  },
  {
    id: 5,
    name: 'Rajan Mehta',
    rating: 5,
    text: 'Completed 30 of the projects as personal challenges. My CSS skills improved dramatically. The snake game project was my favourite!',
    date: '2025-05-30',
  },
  {
    id: 6,
    name: 'Fatima A.',
    rating: 4,
    text: 'Very well organised. Would love a difficulty tag on each project so beginners know where to start.',
    date: '2025-04-10',
  },
];
...
function renderReviews() {
  ...
  if (!list.length) {
    ...
    empty.innerHTML = searchTerm.trim()
...
function initStarPicker() {
  ...
  spans.forEach((span) => {
    span.addEventListener('mouseenter', () => {
      ...
      spans.forEach((s) =>
        s.classList.toggle('hover', Number(s.dataset.val) <= v)
      );
    });
...
function highlightSelected() {
  ...
  spans.forEach((s) =>
    s.classList.toggle('active', Number(s.dataset.val) <= selectedStar)
  );
}
...
function submitReview() {
  ...
  if (text.length < 10)
    return showError('Review must be at least 10 characters.');
