...
searchInput.addEventListener('input', function () {
  ...
  searchResults.innerHTML = matched.map(r => `
...
document.getElementById('qv-plus').addEventListener('click', () => {
  qvQty++; document.getElementById('qv-qty').textContent = qvQty;
});
...
if (slides.length) {
  ...
  sliderEl.addEventListener('mouseleave', () => { sliderInterval = setInterval(nextSlide, 3500); });
