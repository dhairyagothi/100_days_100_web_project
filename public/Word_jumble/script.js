const words = [
  {
    word: 'javascript',
    hint: 'A popular scripting programming language for the web.',
  },
  {
    word: 'computer',
  ...
  {
    word: 'garden',
    hint: 'A space designated for the cultivation of plants and flowers.',
  },
  {
    word: 'library',
  ...
  {
    word: 'balloon',
    hint: 'A brightly colored rubber bag filled with air or gas.',
  },
  {
    word: 'desert',
  ...
  {
    word: 'caravan',
    hint: 'A vehicle equipped for living in, pulled by a car.',
  },
  {
    word: 'castle',
    hint: 'A large fortified building or historical residence.',
  },
  { word: 'cheetah', hint: 'A large spotted cat, the fastest land animal.' },
  {
    word: 'chocolate',
    hint: 'A sweet food preparation made from roasted cacao seeds.',
  },
  { word: 'cinema', hint: 'A theater where motion pictures are shown.' },
  {
    word: 'compass',
    hint: 'An instrument containing a magnetized pointer showing direction.',
  },
  { word: 'cooking', hint: 'The practice or skill of preparing food.' },
  { word: 'crystal', hint: 'A clear, transparent mineral resembling ice.' },
  {
    word: 'diamond',
    hint: 'A precious stone consisting of a clear crystalline carbon.',
  },
  { word: 'dinosaur', hint: 'A fossil reptile of the Mesozoic era.' },
  {
    word: 'dolphin',
    hint: 'A small gregarious toothed whale known for intelligence.',
  },
  { word: 'dragon', hint: 'A mythical monster like a giant winged reptile.' },
  {
    word: 'eclipse',
    hint: 'An obscuring of the light from one celestial body.',
  },
  { word: 'elephant', hint: 'A very large plant-eating mammal with a trunk.' },
  { word: 'emerald', hint: 'A bright green precious stone or jewel.' },
  {
    word: 'espresso',
    hint: 'Strong black coffee made by forcing steam through beans.',
  },
  {
    word: 'feather',
    hint: 'The epidermal growths forming the distinctive outer covering of birds.',
  },
  ...
  {
    word: 'fountain',
    hint: 'An ornamental structure in a pool that spurts water.',
  },
  { word: 'galaxy', hint: 'A system of millions or billions of stars.' },
  { word: 'glacier', hint: 'A slowly moving mass or river of ice.' },
  {
    word: 'goggles',
    hint: 'Close-fitting glasses with side shields for eye protection.',
  },
  ...
  {
    word: 'hammock',
    hint: 'A bed made of canvas or netting suspended by cords.',
  },
  { word: 'harvest', hint: 'The process or period of gathering in crops.' },
  {
    word: 'helicopter',
    hint: 'An aircraft with overhead rotors for vertical lift.',
  },
  {
    word: 'horizon',
    hint: "The line at which the earth's surface and sky appear to meet.",
  },
  {
    word: 'hurricane',
    hint: 'A storm with a violent wind, in particular a tropical cyclone.',
  },
  {
    word: 'iceberg',
    hint: 'A large floating mass of ice detached from a glacier.',
  },
  { word: 'island', hint: 'A piece of land completely surrounded by water.' },
  {
    word: 'jacket',
    hint: 'An outer garment extending either to the waist or the hips.',
  },
  { word: 'jungle', hint: 'An area of land overgrown with dense forest.' },
  {
    word: 'kangaroo',
    hint: 'A large marsupial with strong hind legs for leaping.',
  },
  ...
  {
    word: 'leopard',
    hint: 'A large solitary cat with a yellowish-brown spotted coat.',
  },
  { word: 'lighthouse', hint: 'A tower with a bright light to guide ships.' },
  {
    word: 'lizard',
    hint: 'A reptile that typically has a long body and tail.',
  },
  {
    word: 'luggage',
    hint: "Suitcases or bags containing a traveler's belongings.",
  },
  { word: 'magnet', hint: 'A piece of iron that attracts other iron items.' },
  { word: 'mansion', hint: 'A large, impressive, and expensive house.' },
  {
    word: 'marathon',
    hint: 'A long-distance running race, strictly 26.2 miles.',
  },
  {
    word: 'microscope',
  ...
  {
    word: 'museum',
    hint: 'A building in which objects of interest are stored and exhibited.',
  },
  {
    word: 'necklace',
    hint: 'An ornamental chain or string of beads worn round the neck.',
  },
  { word: 'notebook', hint: 'A book with blank pages for writing notes.' },
  {
    word: 'ocean',
    hint: 'A very large expanse of sea, in particular, each of the main areas.',
  },
  ...
  {
    word: 'ostrich',
    hint: 'A flightless swift-running African bird, the largest living bird.',
  },
  {
    word: 'painting',
    hint: 'The action or skill of using paint to create art.',
  },
  { word: 'palette', hint: 'A thin board on which an artist mixes colors.' },
  { word: 'panther', hint: 'A leopard, especially a black one.' },
  {
    word: 'passport',
    hint: 'An official travel document issued by a government.',
  },
  {
    word: 'penguin',
    hint: 'A large flightless seabird of the southern hemisphere.',
  },
  {
    word: 'perfume',
    hint: 'A fragrant liquid typically made from essential oils.',
  },
  {
    word: 'pyramid',
    hint: 'A monumental structure with a square base and sloping sides.',
  },
  {
    word: 'rainbow',
    hint: 'An arch of colors formed in the sky by rain reflections.',
  },
  {
    word: 'savanna',
    hint: 'A grassy plain in tropical regions with few trees.',
  },
  {
    word: 'scooter',
    hint: 'A light two-wheeled vehicle with a motor or footboard.',
  },
  {
    word: 'sculpture',
    hint: 'The art of making two- or three-dimensional abstract forms.',
  },
  {
    word: 'shadow',
    hint: 'A dark area produced by a body coming between light rays.',
  },
  {
    word: 'skeleton',
    hint: 'An internal or external framework of bone or cartilage.',
  },
  {
    word: 'skyline',
    hint: 'An outline of land and buildings defined against the sky.',
  },
  {
    word: 'spaceship',
    hint: 'A spacecraft designed to carry a crew into interstellar zones.',
  },
  {
    word: 'squirrel',
    hint: 'An agile tree-dwelling rodent with a bushy tail.',
  },
  {
    word: 'submarine',
    hint: 'A warship designed to operate completely underwater.',
  },
  {
    word: 'telescope',
  ...
  {
    word: 'theater',
    hint: 'A building or outdoor area in which plays are performed.',
  },
  {
    word: 'thunder',
    hint: 'A loud rumbling noise heard after a lightning flash.',
  },
  {
    word: 'tornado',
    hint: 'A mobile, destructive vortex of violently rotating winds.',
  },
  {
    word: 'treasure',
    hint: 'A quantity of precious metals, gems, or valuable objects.',
  },
  {
    word: 'umbrella',
    hint: 'A folding cloth canopy on a metallic frame for rain.',
  },
  {
    word: 'volcano',
    hint: 'A mountain or hill having a crater through which lava erupts.',
  },
  { word: 'waterfall', hint: 'A cascade of water falling from a height.' },
  {
    word: 'zeppelin',
    hint: 'A large German dirigible airship of the early 20th century.',
  },
];
...
function checkWord() {
  ...
  if (userWord === correctWord) {
    ...
    if (wrongGuesses >= maxWrongAllowed) {
      ...
      showMessage(
        `❌ Incorrect guess! ${maxWrongAllowed - wrongGuesses} attempts left.`,
        'incorrect'
      );
      userInputEl.value = '';
      userInputEl.focus();
...
function triggerEndScreen(isTimeoutReason) {
  ...
  if (isNewHighScore) {
    ...
    modalAppraisal.textContent =
      "Don't worry, everyone starts somewhere. Check out the hints on the next run!";
...
function quitGame() {
  ...
  userInputEl.value = '';
  messageEl.textContent =
    'Game exited. Refresh the page or press Restart to play again.';
