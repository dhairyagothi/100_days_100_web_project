...
topPipeImg.src = "/public/Flappy-bird-main/toppipe.png";
const bottomPipeImg = new Image();
bottomPipeImg.src = "/public/Flappy-bird-main/bottompipe.png";
const birdImg = new Image();
birdImg.src = "/public/Flappy-bird-main/flappybird.png";
const bgImg = new Image();
bgImg.src = "/public/Flappy-bird-main/flappybirdbg.png";
// ─── Timing ───────────────────────────────────────────────────────────────────
 ...
 */
const BG_SPEED = 0.2; // fraction of pipeSpeed
let bgX = 0;
...
function createPipe() {
  ...
  lastGapY = gapY;
  const thisGap = Math.max(
    MIN_GAP,
    pipeGap + (Math.random() * 2 - 1) * VAR_GAP,
  );
...
function drawHUD() {
  ...
  if (filled > 0) {
    ctx.fillStyle =
      filled > 0.75 ? "#ff5252" : filled > 0.4 ? "#ffe082" : "#80cbc4";
...
function drawStartScreen() {
  ...
  ctx.font = "15px Flappy";
  ctx.fillStyle = "rgba(255,255,255,0.45)";
  ctx.fillText(
    "Difficulty rises every 5 points  ·  P to pause",
    canvas.width / 2,
    canvas.height / 2 + 48,
  );
  ctx.restore();
...
function drawGameOver() {
  ...
  ctx.font = "40px Flappy";
  ctx.fillStyle = "#ffe082";
  ctx.fillText(score, canvas.width / 2 - 110, 322);
  ctx.fillStyle = "#80cbc4";
  ctx.fillText(bestScore, canvas.width / 2 + 110, 322);
