document.addEventListener("DOMContentLoaded", () => {
  ...
  const specialistResponseSection = document.getElementById(
    "specialist-response",
  );
  ...
  let consultationHistory =
    JSON.parse(localStorage.getItem("medConsultHistoryV2")) || [];
  ...
  function handleResponseSubmit(e) {
    ...
    if (!id || !suggestion) {
      showToast(
        "Please provide both Consultation ID and a Suggestion.",
        "error",
      );
      return;
    }
