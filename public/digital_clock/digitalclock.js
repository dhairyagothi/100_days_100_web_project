...
startPomodoroBtn.addEventListener(
  "click",
  startPomodoro
);

pausePomodoroBtn.addEventListener(
  "click",
  pausePomodoro
);

resetPomodoroBtn.addEventListener(
  "click",
  resetPomodoro
);
...
function updatePomodoroDisplay() {
  ...
  pomodoroTimeEl.textContent = `${String(mins).padStart(2, '0')}:${String(secs).padStart(2, '0')}`;
}
