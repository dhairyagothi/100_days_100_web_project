...
function setupEventListeners() {
  ...
  document.getElementById('size-slider').addEventListener('input', (e) => {
    ...
    document.getElementById('size-display').textContent = `${currentSettings.size}px`;
  });

  document.getElementById('speed-slider').addEventListener('input', (e) => {
    currentSettings.speed = parseFloat(e.target.value);
    updateModalPreview();
    document.getElementById('speed-value').textContent = `${currentSettings.speed.toFixed(1)}x`;
    document.getElementById('speed-display').textContent = `${currentSettings.speed.toFixed(1)}x`;
  });
  ...
  document.getElementById('glow-slider').addEventListener('input', (e) => {
    ...
    updateModalPreview();
    document.getElementById('glow-value').textContent = currentSettings.glow.toFixed(1);
  });
  ...
  document.getElementById('download-css-btn').addEventListener('click', downloadCSS);
...
function openModal(id) {
  ...
  document.getElementById('modal-loader-description').textContent = currentLoader.description;
...
function updateModalPreview() {
  ...
  container.className = 'modal-preview-container theme-' + currentSettings.theme;
