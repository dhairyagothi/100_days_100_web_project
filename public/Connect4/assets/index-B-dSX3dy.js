...
` +
    ...
    function Co(e) {
      ...
      if (((po = 0), (H = V = B = null), (mo = !1), (vo = 0), (yo = null), t))
        throw Error(i(300));
      e === null ||
        rc ||
        ((e = e.dependencies), e !== null && ta(e) && (rc = !0));
    }
    function wo(e, t, n, r) {
      B = e;
      var a = 0;
    ...
    function pc(e, t, n) {
      ...
      if (o !== null) {
        ...
        if ((so(t), a))
          ...
          (rc || ea(e, t, n, !1), (a = (n & e.childLanes) !== 0), rc || a)
        ) {
          if (
            ((r = q),
    ...
    function Sc(e, t, n) {
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (o)
          ...
          (rc || ea(e, t, n, !1), (s = (n & e.childLanes) !== 0), rc || s)
        ) {
          if (
            ((s = q),
...
function ro(e, { x: t, y: n }) {
  (no(e.x, t.translate, t.scale, t.originPoint),
    no(e.y, n.translate, n.scale, n.originPoint));
}
...
function Ts(e, t, n, r, i, a) {
  i
    ? ((e.opacity = P(0, n.opacity ?? 1, Ds(r))),
      (e.opacityExit = P(t.opacity ?? 1, 0, Os(r))))
    ...
    applyTransform(e, t = !1, n) {
      ...
      return (
        Za(this.latestValues) &&
          uo(r, this.latestValues, this.layout?.layoutBox),
        r
      );
    }
    removeTransform(e) {
      ...
      for (let e = 0; e < this.path.length; e++) {
        ...
        let r;
        (n.instance &&
          (Xa(n.latestValues) && n.updateSnapshot(),
          (r = R()),
    ...
    setAnimationOrigin(e, t = !1) {
      ...
      ((this.mixTargetDelta = (t) => {
        ...
        (oc(a.x, e.x, n),
          ...
          s &&
            ((this.animationValues = i), Ts(i, r, this.latestValues, n, u, l)),
          this.root.scheduleUpdateProjection(),
          this.scheduleRender(),
...
function hc(e, t, n) {
  return (
    e === `position` || (e === `preserve-aspect` && !Qo(_s(t), _s(n), 0.2))
  );
}
function gc(e) {
...
function al(e, t, n, r) {
  ...
  ((e.projection = new n(
    e.latestValues,
    t[`data-framer-portal-id`] ? void 0 : ol(e.parent),
  )),
...
function G(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
  ...
  function s(n, s) {
    ...
    if (!u && typeof window < `u`) {
      ...
      let t = ul(l);
      ((c = t.MeasureLayout),
        (d.visualElement = il(e, f, l, i, t.ProjectionNode, a)));
    }
    return (0, sl.jsxs)(Ic.Provider, {
      value: d,
      children: [
        c && d.visualElement
          ? (0, sl.jsx)(c, { visualElement: d.visualElement, ...l })
          : null,
...
function dl(e, t) {
  ...
  return new Proxy((e, t) => r(e, t), {
    get: (i, a) =>
      a === `create` ? r : (n.has(a) || n.set(a, G(a, void 0, e, t)), n.get(a)),
  });
}
var fl = (e, t) =>
    (t.isSVG ?? qc(e))
      ? new jo(t)
      : new xo(t, { allowProjection: e !== S.Fragment }),
  pl = class extends Ga {
    constructor(e) {
...
var J = new WeakMap(),
  Y = class {
    ...
    updateAxis(e, t, n) {
      ...
      (this.constraints &&
        this.constraints[e] &&
        (a = Al(a, this.constraints[e], this.elastic[e])),
        i.set(a));
    }
    resolveConstraints() {
...
var Hl = class extends Ga {
  ...
  Wl = class extends Ga {
    ...
    mount() {
      this.removePointerDownListener = vl(
        this.node.current,
        `pointerdown`,
...
var Jl = {
  pan: { Feature: Wl },
  drag: { Feature: Hl, ProjectionNode: yc, MeasureLayout: ql },
};
function Yl(e, t, n) {
  let { props: r } = e;
  e.animationState &&
...
function iu({ root: e, ...t }) {
  ...
  let r = tu.get(n),
    i = JSON.stringify(t);
  return (
    r[i] || (r[i] = new IntersectionObserver(ru, { root: e, ...t })),
    r[i]
  );
}
function au(e, t, n) {
