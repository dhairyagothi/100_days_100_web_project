...
form.addEventListener("submit", function (e) {
  ...
  switch (skinType) {
    case "Oily":
      morningRoutine =
        "Gentle Cleanser • Niacinamide Serum • Oil-Free Moisturizer • Sunscreen";
    ...
    case "Dry":
      morningRoutine =
        "Hydrating Cleanser • Hyaluronic Acid • Rich Moisturizer • Sunscreen";
    ...
    case "Sensitive":
      morningRoutine =
        "Gentle Cleanser • Soothing Moisturizer • Mineral Sunscreen";
    ...
    case "Combination":
      morningRoutine =
        "Foaming Cleanser • Niacinamide • Moisturizer • Sunscreen";
  ...
  document.getElementById("morningRoutine").innerText = morningRoutine;

  document.getElementById("nightRoutine").innerText = nightRoutine;
