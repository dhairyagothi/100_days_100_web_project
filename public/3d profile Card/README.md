...
- Social media link inputs for GitHub, LinkedIn, Twitter/X, and Instagram
- Theme color customization
- Dark and light mode toggle
- Multiple card layouts: Classic, Compact, and Poster
- Interactive 3D card tilt effect
- Download/export profile card as a PNG image
- LocalStorage support to save generated card data
- Link validation for URL fields
...
5. Switch between dark and light mode using the mode icon.
6. Select a card layout from Classic, Compact, or Poster.
7. Preview the card live as you edit.
8. Click the download button to export the card as an image.
