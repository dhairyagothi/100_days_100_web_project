...
import { CheckCircle, XCircle, Lightbulb, TrendingUp, AlertTriangle, ArrowLeft, Target, Key, Zap, CheckSquare, ListChecks, FileDigit, Briefcase, Activity, FileText } from "lucide-react";
...
function ResultPage() {
    ...
    const breakdownItems = [
        ...
        { label: "Clarity", max: 20, data: breakdown.clarity, icon: <Zap size={18} /> },
    ...
    return (
        <div className="max-w-6xl w-full mx-auto mt-10 px-4 pb-16 animate-fade-in-up">
