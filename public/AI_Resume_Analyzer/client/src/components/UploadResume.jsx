...
function UploadResume() {
    ...
    return (
        <div className="max-w-5xl mx-auto mt-12 px-4 w-full animate-fade-in-up">
            <div className="bg-slate-900/80 backdrop-blur-md border border-slate-700/50 p-8 sm:p-12 rounded-3xl shadow-2xl relative overflow-hidden">
                ...
                <h2 className="relative text-4xl font-extrabold mb-10 text-center bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 bg-clip-text text-transparent flex items-center justify-center gap-3">
                    <FileSignature size={36} className="text-blue-400" />
                    AI Resume Analyzer
                </h2>
